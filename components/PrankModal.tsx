  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="relative bg-surface border-4 border-white/10 p-1 md:p-2 rounded-[3rem] max-w-lg w-full overflow-hidden shadow-[0_0_80px_rgba(0,243,255,0.2)]">
        <div className="bg-white text-black p-8 md:p-12 rounded-[2.5rem] text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-5xl md:text-6xl font-black mb-4 uppercase tracking-tighter italic text-red-600 animate-pulse">
              ¡INOCENTE!
            </h2>
            
            <div className="h-1 w-24 bg-red-600 mx-auto mb-6"></div>

            <p className="text-2xl font-bold mb-2 text-gray-900 leading-tight">
            ...
            <div className="space-y-4">
              <div className="bg-red-50 border-2 border-dashed border-red-200 p-4 rounded-2xl">
                <p className="text-sm font-mono text-red-800 uppercase tracking-widest font-bold mb-1">
                  Estado del Sorteo:
                </p>
                <p className="text-red-600 font-bold">CANCELADO POR EXCESO DE HUMOR</p>
              </div>
            ...
            <button
              onClick={onClose}
              className="mt-10 w-full bg-black text-white font-black py-5 px-8 rounded-2xl hover:bg-gray-900 transition-all transform hover:scale-[1.02] active:scale-95 shadow-xl flex items-center justify-center gap-3 group"
            >
              <span>VOLVER A LA REALIDAD</span>
